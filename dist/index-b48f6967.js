...
const readFileP = promisify(fs$1.readFile);
...
var sync = globby$1.exports.sync = (patterns, options) => {
	const globTasks = generateGlobTasks(patterns, options);
...
var stream = globby$1.exports.stream = (patterns, options) => {
	const globTasks = generateGlobTasks(patterns, options);
...
var generateGlobTasks_1 = globby$1.exports.generateGlobTasks = generateGlobTasks;

var hasMagic = globby$1.exports.hasMagic = (patterns, options) => []
	.concat(patterns)
	.some(pattern => fastGlob.isDynamicPattern(pattern, options));

var gitignore_1 = globby$1.exports.gitignore = gitignore;

var index = /*#__PURE__*/_mergeNamespaces({
	__proto__: null,
	sync: sync,
	stream: stream,
	generateGlobTasks: generateGlobTasks_1,
	hasMagic: hasMagic,
	gitignore: gitignore_1,
	'default': globby$1.exports
}, [globby$1.exports]);
